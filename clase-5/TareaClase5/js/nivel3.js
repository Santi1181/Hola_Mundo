...
const nuestroTitulo = document.querySelector('h1').innerText
...
document.querySelector('h1').textContent = 'Hola Santiago!!!'
...
const nuevoParrafo = document.createElement('img')
nuevoParrafo.src = 'img/woman_bw.jpg'
document.querySelector('header').appendChild(nuevoParrafo)	

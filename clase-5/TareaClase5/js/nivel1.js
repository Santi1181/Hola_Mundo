...
// Tareas Clase 1 - Introducción

/* 
    Crear una función que tome como parametro el año actual y el año de nacimiento y 
    calcule la edad del usuario (mas o menos)
    Preguntarle estos datos al usuario y guardarlos en dos variables 
    Ejecutar la función con estos datos
    Impriman el resultado en la consola

    Adicional:
         - Preguntar salario anual y calcular salario mensual
         - Preguntar salario mensual y calcular salario anual

*/
    // Ejecicio 1:
    
    /*
    let anoActualIngresado = Number(prompt('Ingrese el año actual: '))     
    let anoNacimientoIngresado = Number(prompt('Ingrese el año de su nacimiento: '))     

    function obtenerEdadUsuario (anoActual,anoNacimiento) {
        return anoActual - anoNacimiento;
    }

    console.log ('Usted tiene: ' + obtenerEdadUsuario(anoActualIngresado,anoNacimientoIngresado) + ' años')   

    //Ejercicios Adicionales: Salario Mensualizado y Anualizado:
        
    let salarioAnualIngresado = Number(prompt('Ingrese su salario anual aproximado: '))     

    function obtenerSalarioMensual (salarioAnual) {
        return salarioAnual / 12;
    }

    console.log ('Usted mensualmente cobra aproximadamente: ' + obtenerSalarioMensual(salarioAnualIngresado))   
    */

    /*let salarioMensualIngresado = Number(prompt('Ingrese su salario mensual aproximado: '))

    function obtenerSalarioAnual (salarioMensual) {
        return salarioMensual * 12;
    }
    
    console.log ('Usted anualmente cobra aproximadamente: ' + obtenerSalarioAnual(salarioMensualIngresado))
    */
...
const operador = (prompt('Ingrese que desea realizar, en caso de "SUMA" ingrese +, en caso de "RESTA" ingrese - '))
...
if (operador === '+') {
    console.log ('Esto es una SUMA ' + sumar(numeroUno,numeroDos))
} else {
    console.log ('Esto es una RESTA ' + restar(numeroUno,numeroDos))   
}
...
if (nombreIngresado.toLowerCase() === 'santiago') {
    console.log(`Hola, Tocayo! yo tambien me llamo ${nombreIngresado}`)
} else if (nombreIngresado.toLowerCase() === 'fabricio') {
    console.log(`Hola, ${nombreIngresado}!, te llamas igual a mi amigo ${nombreIngresado}`)
} else {
    console.log(`Hola, ${nombreIngresado}! `)
}

//Tarea 2:
let edadIngresada = Number(prompt('Cual es tu edad?: '))
const miEdad = 40

if (edadIngresada === miEdad) {
    console.log(`Hola, considerando que tienes ${edadIngresada} años, tienes mi misma edad `)
} else if (edadIngresada > miEdad) {
    console.log(`Hola, considerando que tienes ${edadIngresada} años, eres mayor que yo `)
} else {
    console.log(`Hola, considerando que tienes ${edadIngresada} años, eres menor que yo `)
}
*/
//Tarea 3:
let datoDocumento = prompt('Hola, tienes documento? (indique Si / No): ')

if (datoDocumento.toLowerCase() === 'si') {
    const edadMinima = 18
    let edadIngresada = Number(prompt('Que edad tienes?: '))
    if (edadIngresada >= edadMinima) {
        console.log (`Bienvenido, puedes ingresar al BAR porque tienes documento y tu edad es ${edadIngresada}`)
    } else if (edadIngresada < edadMinima) {
        console.log (`No puedes ingresar al BAR, a pesar que tengas documento ya que tienes ${edadIngresada} años`)
    }
} else if (datoDocumento.toLowerCase() === 'no'){
    console.log (`No puedes ingresar al BAR, ya que no tienes documento`)
} else {
    console.log (`La opción ingresada no es valida, ingreso ${datoDocumento}, y debe ingresar Si o No`)
}
